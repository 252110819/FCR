...
import com.awei.photopicker.adapters.FolderAdapter;
import com.awei.photopicker.adapters.PhotoAdapter;
import com.awei.photopicker.beans.Photo;
import com.awei.photopicker.beans.PhotoFolder;
import com.awei.photopicker.utils.OtherUtils;
import com.awei.photopicker.utils.PhotoUtils;
...
public class PhotoPickerActivity extends Activity implements PhotoAdapter.PhotoClickCallBack {
    ...
    private void selectPhoto(Photo photo) {
        scholardesign.awei.com.flowercapturingrecognize.Utils.LogUtils.d("selectPhoto");
        if (photo == null) {
            return;
        }
    ...
    public void onPhotoClick() {
        scholardesign.awei.com.flowercapturingrecognize.Utils.LogUtils.e("onPhotoClick");
